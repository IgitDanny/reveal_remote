...
var Reveal = (function(){
	...
	var levt,revt,uevt,devt,nevt,pevt;
	(function () {
		levt = document.createEvent("Event");
		levt.initEvent("navigateLeft",true,true);

		revt = document.createEvent("Event");
		revt.initEvent("navigateRight",true,true);
	
		uevt = document.createEvent("Event");
		uevt.initEvent("navigateUp",true,true);
		
		devt = document.createEvent("Event");
		devt.initEvent("navigateDown",true,true);
		
		nevt = document.createEvent("Event");
		nevt.initEvent("navigateNext",true,true);
		
		pevt = document.createEvent("Event");
		pevt.initEvent("navigatePrev",true,true);
	})();
